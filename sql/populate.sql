...
INSERT INTO `faculty` (`faculty_id`, `first_name`, `emailid`, `password`, `address`, `DOB`, salary, position) VALUES ('4', 'Balaji Aryan Singh', 'rar@trr.com', '81dc9bdb52d04dc20036dbd8313ed055', '012-Hauz-Khas new-delhi', '1975-12-07', 80000, 'Associate Professor');
...
INSERT INTO `faculty` (`faculty_id`, `first_name`, `emailid`, `password`, `address`, `DOB`, salary, position) VALUES ('6', 'Aryan', 'rm@trr.com', '81dc9bdb52d023424bd8313ed055', '211-dugri- new-delhi', '1976-12-07', 80000, 'Professor');
